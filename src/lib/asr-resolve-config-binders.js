    ...
    parseBindersConfig(vueInstance, bindersConfig) {
        ...
        bindersConfig.forEach(binderItem => {
            ...
            if (
                ...
                const namespace = this.resolveNamespace(vueInstance.$store.state, binderItem.namespace);
                storeConfigItems.push(
                    namespace[binderItem.bind]
                );
            }
        });
        ...
        storeConfigItems.forEach(storeConfigItem => {
            ...
            storeConfigItem.forEach(item => {
                ...
                storeLocationObject.binderType = item.binderType ? item.binderType: false;
