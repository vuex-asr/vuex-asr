    ...
    * */
    ...
    parseBindersConfig(Router, ResolveConfigBinders) {
        ...
        this.configBindersForMethods = this.resolvedConfigBinders.filter(item => {
            return (item.binderType === 'mutations' ||
                item.binderType === 'actions'
            )
        });
    ...
    mergeBindersArraysForComputed(Router) {
        ...
        this.bindersGetters = this.bindersGetters !== null ? this.bindersGetters : [];
        this.bindersConfig = this.bindersConfig !== null ? this.bindersConfig : [];
        this.configBindersForComputed = this.configBindersForComputed !== undefined ? this.configBindersForComputed : [];
    ...
    mergeBindersArraysForMethods(Router) {
        ...
        this.bindersMutations = this.bindersMutations !== null ? this.bindersMutations : [];
        this.bindersActions = this.bindersActions !== null ? this.bindersActions : [];
        this.configBindersForMethods = this.configBindersForMethods !== undefined ? this.configBindersForMethods : [];
